...
class PackageOrderApplication(models.Model):
    ...
    applicant_id_card = models.FileField(null=True)
    company_registration_document = models.FileField(null=True)
    bank_statements = models.FileField(null=True)
    recent_utility_bill = models.FileField(null=True)
